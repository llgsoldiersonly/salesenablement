/* Re-exports the domain types used across the app. Mirrors spike/probe/src/types.ts. */
...
/* ── Package types (mirrors spike/probe/src/packages.ts) ─────────────── */
...
export type TabId = "overview" | "intake" | "competitors" | "calculator" | "notes" | "activity" | "admin";
